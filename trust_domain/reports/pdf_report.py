...
def _make_footer_canvas(firm_name: str, period: str):
    ...
    disclaimer_line = (
        "This report is generated by TrustSentry, a deterministic rule-based "
        "compliance tool. It does not constitute a legal opinion or a "
        "certified audit under the Lawyers and Conveyancers Act 2006."
    )
    ...
    class _FooterCanvas(pdfgen_canvas.Canvas):
        ...
        def _stamp_footer(self, page_num: int, total: int) -> None:
            ...
            self.drawCentredString(_PAGE_WIDTH / 2, _FOOTER_Y + 4, disclaimer_line)
